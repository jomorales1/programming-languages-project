...
/**
 * This class provides an empty implementation of {@link picalcVisitor},
 ...
 */
public class picalcBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements picalcVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 */
	@Override public T visitBlock(picalcParser.BlockContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
